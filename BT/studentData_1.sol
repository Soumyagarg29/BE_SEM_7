...
//free ETH  needed to connect ot the wallet =>tried using alchemy but it requires minium credits (0.01)
//we can still deploy and test on the VM 
//realistic use of fallback functions is not yet understood 
